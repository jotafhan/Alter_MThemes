...
ARQUIVOS_ATUALIZAVEIS=(
    ...
    "lib/cat_6_performance_center.sh|lib/cat_6_performance_center.sh"
    "lib/cat_7_interface_ui.sh|lib/cat_7_interface_ui.sh"
    "lib/cat_8_atualizador.sh|lib/cat_8_atualizador.sh"
