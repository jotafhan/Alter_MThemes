#!/bin/bash
# =========================================================
# cat_9_atualizador.sh — Atualizador do Alter_MThemes
# Alter_MThemes v7.0 - Modulo 9
# =========================================================
#
...
UPDATE_BASE_URL="https://cdn.jsdelivr.net/gh/jonata794/Alter_MThemes@main"
# Exemplo GitHub:
# UPDATE_BASE_URL="https://raw.githubusercontent.com/joao/alter-mthemes/main"
...
ARQUIVOS_ATUALIZAVEIS=(
    ...
    "lib/cat_1_fonte.sh|lib/cat_1_fonte.sh"
    "lib/cat_2_gradiente.sh|lib/cat_2_gradiente.sh"
    "lib/cat_3_logos.sh|lib/cat_3_logos.sh"
    "lib/cat_4_temas_prontos.sh|lib/cat_4_temas_prontos.sh"
    "lib/cat_6_gerenciamento.sh|lib/cat_6_gerenciamento.sh"
    "lib/cat_7_otimizacao.sh|lib/cat_7_otimizacao.sh"
    "lib/cat_8_aparencia_menu.sh|lib/cat_8_aparencia_menu.sh"
    "lib/cat_9_atualizador.sh|lib/cat_9_atualizador.sh"
)
...
_upd_verificar() {
    ...
    if [ -z "$TMP_VER" ]; then
        dialog --output-fd 1 \
            --backtitle "$(_menu_preview_backtitle 2>/dev/null || echo "$APP_NAME $APP_VER")" \
            --title " Erro " \
            --msgbox "Nao foi possivel acessar o servidor.\nURL: ${UPDATE_BASE_URL}\n\nVerifique a configuracao da URL no modulo 9." \
            9 60 2>"$CURR_TTY"
        return 1
    fi
